...
<Frame>
  <img alt="Web Editor" src="https://mintlify.s3.us-west-1.amazonaws.com/mintlify/images/quickstart/web-editor-light.png" className="block dark:hidden" />

  <img alt="Web Editor" src="https://mintlify.s3.us-west-1.amazonaws.com/mintlify/images/quickstart/web-editor-dark.png" className="hidden dark:block" />
</Frame>
